...
setup_frontend () {
    cd frontend/simplest_frontend_app && npm install
...
generate_django_secret_key() {
    echo "From generate_django_secret_key()"
    cd simplest_twitter_project/simplest_twitter_project && python3 keygen.py
